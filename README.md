...
平台管理员维护类目、商家、优惠券和手动排序权重；学生浏览商家列表、进入详情并填写手机号/昵称领取优惠券；商家在 H5 后台查看经营指标、维护店铺资料和优惠券，并输入核销码完成到店核销；系统统计曝光、点击、领取和核销数据。首版只做目录、优惠券、核销归因和手动排序，不做在线支付、自动扣费和微信小程序原生工程。
