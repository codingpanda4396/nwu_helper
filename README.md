...
面向西北大学周边商家的本地生活增长平台 MVP，覆盖学生端商家发现、优惠券领取、曝光/点击/领取统计，以及平台人工运营后台。
...
平台管理员维护类目、商家、优惠券和手动排序权重；学生在 H5 浏览商家列表、进入详情并填写手机号/昵称领取优惠券；系统统计曝光、点击和领取数据。首版只做 H5 用户端、目录、优惠券和手动排序，不做在线支付、自动扣费和原生客户端工程。
