...
- 商家演示账号：`18800000011` / `merchant123456`
...
平台管理员维护类目、商家、优惠券和手动排序权重；学生浏览商家列表、进入详情并领取优惠券；商家在 H5 后台查看领取记录并输入核销码完成核销；系统统计曝光、点击、领取和核销数据。首版只做目录、优惠券、核销归因和手动排序，不做自动竞价、在线支付和微信小程序原生工程。
